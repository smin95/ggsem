...
The **ggsem** app also provides support for adding math expressions. Under the **Text Annotation Inputs** menu, make sure to check the box for **Use Math Expression** (in the orange box), and your **Text** can follow the syntax for math expressions of the function `parse()`. In the **ggsem** app, just write strings without the function `parse()`. 
