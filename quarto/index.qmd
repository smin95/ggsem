...
```{r}
#| eval: false 
# install.packages(c("colourpicker", "DT", "DiagrammeR", "ellmer", "memoise", "shiny", "shinyjs", "svglite"), dependencies = TRUE)

install.packages("ggsem") # version 0.9.7
```
