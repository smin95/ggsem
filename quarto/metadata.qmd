...
## 3. Load Metadata to Continue  {.unnumbered}

If you load metadata onto the application, you will be able to trace back to previous clicks or progress further. Specify the filename for the `metadata` argument within `ggsem()`.

```{r}
#| eval: false
ggsem(metadata = 'ggsem_metadata.rds')
```
